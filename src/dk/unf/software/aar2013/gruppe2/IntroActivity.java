...
public class IntroActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		game = (Button) findViewById(R.id.b_play);
		facts = (Button) findViewById(R.id.morefacts);
		highscore = (Button) findViewById(R.id.highscore);
		exit = (Button) findViewById(R.id.exit);
		
		final Intent piratefacts = new Intent (this, pirateFactsActivity.class );
		final Intent startGame = new Intent(this,MainActivity.class);
		final Intent higscore  = new Intent(this,HigscoreActivity.class);
